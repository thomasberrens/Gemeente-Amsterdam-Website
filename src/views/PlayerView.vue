  ...
  <div class="flexbox flex-col md:flex-row">
    <div class="md:w-1/4 p-4">
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-4">
          <h2 class="font-bold text-lg mb-2">{{ playerInfo.username }}</h2>
    ...
    <div class="md:w-3/4 p-4">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div v-for="(gameInfo, index) in playerInfo.gamesPlayed" :key="index" class="bg-white rounded-lg shadow-md overflow-hidden">
          <div class="p-4">
